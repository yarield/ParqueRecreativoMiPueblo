...
export const paqueteSchema = z.object({
  ...
  // En modo abierto el precio puede quedar vacío; en modo fijo es obligatorio
  // (se valida más abajo, donde ya se conoce precio_abierto).
  ...
  (d) => d.precio_abierto || d.precio != null,
